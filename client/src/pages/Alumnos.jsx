            ...
            <div className="relative bg-white p-6 rounded-md w-4/5 h-[80vh] overflow-hidden custom-scrollbar overflow-y-scroll">
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="mb-2">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 mt-2 text-black">
                      {deportes.map(deporte => (
                        <div key={deporte.value}>
                          ...
                          />
                          <label htmlFor={deporte.value} className="ml-1">
                            {deporte.label}
                          </label>
                        </div>
                      ))}
                  ...
                  {isSubmitted && alumnoToCreate.deporte.length === 0 && (
                ...
                <div className="mb-2">
                  ...
                  <select
                    {...register('plan', {
                      required: 'Selecciona una opción de plan',
                    })}
                  ...
                  >
                    ...
                    <option value="Plan Natación">Plan Natación</option>
                ...
                <div className="mb-2 mt-2">
                  <div className="mb-2">
                    ...
                    <div className="flex items-center">
                      ...
                      <Input
                        type="text"
                        value={alumnoToCreate.precioEfectivo}
                        className="w-full bg-zinc-700 text-white px-4 py-2 rounded-md"
                        onChange={e =>
                          setAlumnoToCreate({
                            ...alumnoToCreate,
                  ...
                  <div className="mb-2">
                    ...
                    <div className="flex items-center">
                      ...
                      <Input
                        type="text"
                        value={alumnoToCreate.precioTransferencia}
                        className="w-full bg-zinc-700 text-white px-4 py-2 rounded-md"
                        onChange={e =>
                          setAlumnoToCreate({
                            ...alumnoToCreate,
